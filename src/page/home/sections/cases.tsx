...
const items: IPropsCaseItem[] = [
    {
        ...
        desc: <>
            ...
            <br /> <br />
            <strong>Что сделали мы:</strong> разработали новый сайт с акцентом на готовые пакеты ремонта, встроили калькулятор стоимости и сценарии «под ключ». Запустили рекламу в Яндекс.Директ по горячим запросам и настроили аналитику для прозрачного учёта лидов.
            <br /> <br />
            <strong>Результат:</strong> сайт и реклама окупились уже за первые 2 недели. Количество лидов увеличилось в 6 раз по сравнению с сарафаном, а выручка выросла на +6,5 млн ₽ всего за первые 2 месяца.
        </>
    },
    {
        img: '/project2.jpeg',
        ...
        desc: <>
            У компании был старый сайт с конверсией всего 3,1%. Реклама уже шла, но заявки обходились слишком дорого, клиентов почти не было.
            <br /> <br />
            <strong>Что сделали мы:</strong> сделали новый сайт с нуля, добавили калькулятор — ключевой этап воронки, усилили доверие ЦА блоками «команда», «договор», «поэтапная оплата», дополнили оффер актуальными акциями.
            <br /> <br />
            <strong>Результат:</strong> конверсия выросла с 3,1% до 17,9%. Заявок стало в 5 раз больше. +4,5 млн ₽ к выручке за месяц.
        </>
    },
    {
        img: '/project3.jpeg',
        ...
        desc: <>
            Новый бизнес — сеть фитнес-клубов. До запуска не было ни сайта, ни рекламы. Важно было стартовать громко, чтобы быстро занять место в конкурентной нише.
            <br /><br />
            <strong>Что сделали мы:</strong> создали стильный современный сайт с видео-клипами, обработанными с помощью AI, разработали яркое позиционирование бренда, запустили рекламу в таргете и поиске с упором на горячую аудиторию.
            <br /><br />
            <strong>Результат:</strong> сайт стал главным конвертером трафика — вся реклама и продвижение шли через него с высокой конверсией. В первый месяц — максимальная посещаемость почти каждый день. Бренд закрепился в топе рынка города с первого же запуска.
        </>
    },
]
...
function Cases() {
    ...
    return (
        <div id="cases" className="container flex flex-col gap-[4.5rem] scroll-mt-[6.25rem] max-md:scroll-mt-[4rem]">
