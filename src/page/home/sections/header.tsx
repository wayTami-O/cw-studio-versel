...
function Header() {
    return (
        <header className="fixed top-0 left-1/2 -translate-x-1/2 max-w-[110rem] h-[6.25rem] flex justify-between items-center bg-white z-20 !w-full
            ...
            <div className="flex items-center gap-[5rem]">
                ...
                <div className="w-[4.25rem] h-[4.25rem] flex justify-center items-center border-[0.0625rem] border-[#13151d29] rounded-full max-md:w-[3.25rem] max-md:h-[3.25rem]">
