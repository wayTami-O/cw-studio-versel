            ...
            <header className="fixed top-0 left-1/2 -translate-x-1/2 max-w-[110rem] h-[6.25rem] flex justify-between items-center bg-white z-[100] !w-full
                ...
                <div className="flex items-center gap-[5rem]">
                    <div className="flex items-center gap-[1.25rem] desktop">
                        <a href="#cases" className="px-[1rem] py-[0.625rem] hover:bg-[#f5f5f5] transition-all ease-out duration-300 cursor-pointer rounded-[0.75rem]">Кейсы</a>
                        <a href="#services" className="px-[1rem] py-[0.625rem] hover:bg-[#f5f5f5] transition-all ease-out duration-300 cursor-pointer rounded-[0.75rem]">Услуги</a>
                        <a href="#company" className="px-[1rem] py-[0.625rem] hover:bg-[#f5f5f5] transition-all ease-out duration-300 cursor-pointer rounded-[0.75rem]">Компания</a>
                        <a href="#contact-form" className="px-[1rem] py-[0.625rem] hover:bg-[#f5f5f5] transition-all ease-out duration-300 cursor-pointer rounded-[0.75rem]">Карьера</a>
                        <a href="#contacts" className="px-[1rem] py-[0.625rem] hover:bg-[#f5f5f5] transition-all ease-out duration-300 cursor-pointer rounded-[0.75rem]">Контакты</a>
                    </div>
                    <div
