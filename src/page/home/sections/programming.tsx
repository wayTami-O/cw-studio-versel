        ...
        <div className="container flex flex-col gap-[7.5rem]">
            <div className="flex justify-between items-center max-md:flex-col max-md:gap-[1rem]">
                <div className="max-w-[50.5rem] w-full flex flex-col">
                    ...
                    <a href="#" className="mt-[3.5rem] text-[1.125rem] w-fit flex items-center px-[2rem] h-[4.25rem] bg-[#13151d] text-white rounded-[0.75rem] max-md:w-full max-md:justify-center">Связаться с нами</a>
                </div>
